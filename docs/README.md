...
- **`docs/`** — the *why*. Reasoning, analysis, decisions, and deliverables. Read from
  start to finish. This is where the 2-pager comes from.
- **`specs/`** — the *what*. Contract for each component: inputs, outputs, acceptance
  criteria. Consulted as needed and kept in sync with the code.
...
|---|---|---|
| [00-action-plan.md](00-action-plan.md) | Plan for the 5–10 hours, proposed architecture, timeline | ✅ |
...
| [03-policies.md](03-policies.md) | The 12 policies, decided and switchable (P-12: unstated finish) | ✅ |
...
| [10-timeline.md](10-timeline.md) | Project timeline: how it's been iterated on and reasoned through, session by session | ✅ |
| [domain/](domain/) | Industry knowledge: what an MTO is, the 5 materials, standards, grades, finishes. For reading the Excel without being a buyer | ✅ |
| [11-benchmarks.md](11-benchmarks.md) | All measurements, with method, dates, and limitations | ✅ |
...
The 2-pager has six sections mandated by the brief. Each is fed by a doc, so it
doesn't get written from scratch on the last day:
