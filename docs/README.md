...
- **`docs/`** — the *why*. Reasoning, analysis, decisions, and deliverables. Read start to finish.
  It's what the 2-pager comes from.
...
| [10-timeline.md](10-timeline.md) | Project timeline: how it was iterated and reasoned through, session by session | ✅ |
...
| [design-system/](design-system/DESIGN-SYSTEM.md) | Sapira's design system extracted from sapira.ai, for the buyer's UI | ✅ |

Legend: ✅ closed · 🚧 in progress · ⬜ pending

## Traceability to the 2-pager

The 2-pager has six sections mandated by the brief. Each is fed by a doc, so it doesn't get
